              ...
              <html>
                ...
                <body>
                  <div class="container">
                    ...
                    <p>Best regards,<br />Genius Junction</p>
                  </div>
                </body>
              </html>
            `;
...
exports.getCertificate = async (req, res, next) => {
    try {
        ...
        addWrappedText(`an online non-credit course authorized by ${educator.fname}` + ' ' + `${educator.lname} and offered through Genius Junction.`, yPos, 400, 12, 5, fontPath);
        yPos += doc.heightOfString(`an online non-credit course authorized by ${educator.fname}` + ' ' + `${educator.lname} and offered through Genius Junction.`, { width: 400 }) + 50;
        ...
        doc
            .font(fontPath)
            .fontSize(7)
            .text("Genius Junction has confirmed the identity of this individual and their participation in the course.", 575, 500, { width: 200 });
