...
const Footer = ({id}) => {
  return (
    ...
    <div id={id}>
          ...
          <div className='box last'>
            ...
            <ul>
              ...
              <li>
                ...
                <a href="mailto:genius_junction@gmail.come">genius_junction@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className='legal'>
        <p>
          Copyright ©2023 All rights reserved | Genius Junction <i className='fa fa-heart'></i>
        </p>
      </div>
      </div>
    </>
